...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'jpx91VKvMH0C726RwGkb7emN4NDpmX1liXEcXphoNj1ftFWaN4')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DJANGO_DEBUG', '') != 'False'

ALLOWED_HOSTS = ['.herokuapp.com','127.0.0.1', 'localhost', '.hackernews.ee']
